...
/// Msgr Business - For team collaboration and workspace messaging
Future<void> main() async {
  const bootstrapper = Bootstrapper();
  await bootstrapper.initialize();

  // Set app mode to business for filtering
  // This will be used by providers to filter work content
  Logger.root.info('Starting Msgr Business (Bundle: dev.meeh.messngr.business)');
