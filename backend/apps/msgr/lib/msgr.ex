defmodule Messngr do
  ...
  def update_conversation(conversation_id, attrs),
    do: Chat.update_conversation(conversation_id, attrs)
  ...
  defdelegate create_media_upload(conversation_id, profile_id, attrs),
    to: Media,
    as: :create_upload
