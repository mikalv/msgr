defmodule Messngr.Repo.Migrations.CreateDevicePushTokens do
  ...
  def change do
    create table(:device_push_tokens, primary_key: false) do
      ...
      add :device_id, references(:account_devices, type: :binary_id, on_delete: :delete_all),
        null: false
    ...
    create unique_index(:device_push_tokens, [:device_id, :platform],
             name: :device_push_tokens_device_platform_index
           )
