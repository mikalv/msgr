defmodule AuthProvider.Oauth.IntrospectController do
  ...
  alias AuthProvider.OauthView

  def oauth_module, do: Application.get_env(:auth_provider, :oauth_module, Boruta.Oauth)
