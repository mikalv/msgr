defmodule FamilySpace.ShoppingList do
  @moduledoc """
  Shopping lists tied to a collaborative space.
  """
  ...
  schema "shopping_lists" do
    ...
    has_many :items, FamilySpace.ShoppingItem, preload_order: [asc: :inserted_at]
