...
Vi må finne ut hvilke prosjekt som er best utgangspunkt for det vi prøver å løse. Per chat-network.
...
* https://gitlab.com/mx-puppet/slack/mx-puppet-slack
...
* https://github.com/mattermost/matrix-as-mm
...
* https://git.kappach.at/lda/Parsee
